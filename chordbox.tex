...
\tikzset{chordbox/.append style={baseline}}
...
through the configuration key \texttt{\hyperref[key:numfrets]{/chordbox/numfrets}}.
...
see \texttt{}\texttt{\hyperref[key:textbelow]{/chordbox/text below}}
and \texttt{\hyperref[key:textonnode]{/chordbox/text on node}}. They
are illustrated below, where the letter T is used for the thumb and
the digits for the other fingers, starting at 1 for the index finger.
The larger chord box on the right has been given a scale of 2.5 times
the default.
\begin{center}
\begin{tabular}[t]{cc}
...
given to the command and the configured tuning (\texttt{\hyperref[key:tuning]{/chordbox/tuning}}).
...
Pitch names may include accidentals, so underneath the chord box they
are displayed at \texttt{\textbackslash scriptsize} to avoid overlapping
at the default picture scale.
...
\begin{description}
\item [{/chordbox/numfrets\texttt{\textcolor{black}{\small{}=\textlangle }}\texttt{\textcolor{black}{\emph{\small{}number}}}\texttt{\textcolor{black}{\small{}\textrangle }}\label{key:numfrets}}] \hfill{}(initially
\texttt{4}) \\
...
\begin{description}
\item [{/chordbox/text~below\texttt{\textcolor{black}{\small{}=none|fingering|pitch}}\label{key:textbelow}}] \hfill{}(initially
\texttt{fingering})\\
Selects what to display below each string.
\item [{/chordbox/text~on~node\texttt{\textcolor{black}{\small{}=none|fingering|pitch}}\label{key:textonnode}}] \hfill{}(initially
\texttt{none})\\
...
\item [{/chordbox/tuning\texttt{\textcolor{black}{\small{}=\textlangle }}\texttt{\textcolor{black}{\emph{\small{}list~of~pitches}}}\texttt{\textcolor{black}{\small{}\textrangle }}\label{key:tuning}}] \hfill{}(initially
\texttt{\{"E","A","D","G","B","E"\}})\\
